...
by adding or updating attribute.
    ...
    def get_objects(self, instance=''):
        """Gets the elements created on the console.
        Args:
            instance (:obj:`str`, optional): The instance to finds into
                the objects.
        Returns:
            list: If the `instance` argument is not empty, it will search
            only for objects that match the instance. Otherwise, show
            all instances in the file.
        """
    ...
    def default(self, line):
        ...
        and links it to the corresponding method.
        """
        if '.' in line:
    ...
    def emptyline(self):
        """
        When an empty line is entered to the prompt,
